...
if(hit > 0)
{
	...
	draw_sprite_ext(sprite_index,image_index,x+dt_draw_x+dt_draw_x_2,y+dt_draw_y+dt_draw_y_2,_xscale*x_dir/yscale_ratio,_yscale*yscale_ratio,image_angle,image_blend,image_alpha);
	shader_reset();
}
else
{
	draw_sprite_ext(sprite_index,image_index,x+dt_draw_x+dt_draw_x_2,y+dt_draw_y+dt_draw_y_2,image_xscale*x_dir/yscale_ratio,image_yscale*yscale_ratio,image_angle,image_blend,image_alpha);
}
